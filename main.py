...
================================================================================
Автор: [ВАШЕ ФИО]
Тема ВКР: Разработка системы 3D реконструкции объектов мебели 
          на основе одиночных изображений с использованием 
          глубоких нейронных сетей
          
Описание: Графический интерфейс для обучения, тестирования и применения
          модели Pixel2Mesh для генерации 3D моделей из 2D изображений
